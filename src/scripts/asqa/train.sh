...
source /home/dju/miniconda3/etc/profile.d/conda.sh
...
accelerate launch \
    ...
    --split train \
	--corpus_file $DATASET_DIR/wikipedia_split/ \
	--retrieval_file $DATASET_DIR/asqa/train_data_bm25-top100.run \
    ...
    --index_dir /home/dju/indexes/wikipedia_split/splade-v3.psgs_w100.lucene \
