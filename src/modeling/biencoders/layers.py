...
class AttentionLayer(BertSelfAttention):
    ...
    def forward(
        ...
        #######################################
        # we are goining to output the scores #
        #######################################
        outputs = (context_layer, attention_scores) if output_attention_scores else (context_layer, attention_probs)
