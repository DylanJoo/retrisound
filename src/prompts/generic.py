...
prompt_report_gen = "Write a passage that answers the given query: {Q}. Use your remembered information and identify the relevant information to draft the passage. Write the passage within 100 words."
