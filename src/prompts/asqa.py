...
instruction_prompt_new = "Determine whether the question can be answered based on the following search result? (the suggested answer to the question is also provided as reference). Rate the search result with on a scale from 0 to 1, using 0, 0.5 or 1 according to the guideline below. Do not write anything except the rating.\n\nGuideline:\n- 1: The search result can be used to answer the question and provide related details.\n-0.5: The search result can only used to answer the question.\n- 0: The search result cannot be used to answer the question."
